 ...
 */
std::ostream& operator<<(std::ostream& os, const structures::Dummy& dummy) {
    os << dummy.value();
    return os;
}
 ...
 */
const auto dummy_values = std::vector<structures::Dummy>{
    structures::Dummy{0.},
    structures::Dummy{-5.},
    structures::Dummy{10.},
    structures::Dummy{7.5},
    structures::Dummy{-5.5},
    structures::Dummy{3.1415},
    structures::Dummy{4.2},
    structures::Dummy{-10.},
};
...
protected:
     ...
     */
    structures::AVLTree<structures::Dummy> dummy_list{};
...
TEST_F(AVLTreeTest, NotContains) {
    ...
    ASSERT_FALSE(dummy_list.contains(structures::Dummy{4.3}));
}
...
TEST_F(AVLTreeTest, Remove) {
...

    {
        ...
        auto dummy = structures::Dummy{4.2};
...
TEST_F(AVLTreeTest, PreOrder) {
...

    {
        ...
        auto i = 0u;
        for (auto& value : expected) {
            ASSERT_EQ(structures::Dummy{value}, preordered[i]);
            ++i;
        }
    }
}
...
TEST_F(AVLTreeTest, InOrder) {
...

    {
        ...
        auto i = 0u;
        for (auto& value : expected) {
            ASSERT_EQ(structures::Dummy{value}, inordered[i]);
            ++i;
        }
    }
}
...
TEST_F(AVLTreeTest, PostOrder) {
...

    {
        ...
        auto i = 0u;
        for (auto& value : expected) {
            ASSERT_EQ(structures::Dummy{value}, postordered[i]);
            ++i;
        }
    }
}
